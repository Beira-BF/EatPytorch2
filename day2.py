...
# 模型并辅助应用模型容器(nn.Sequential, nn.ModuleList, nn.ModuleDict)进程封装。
...
# 三、训练模型
# Pytorch通常需要用户编写自定义训练循环训练循环的代码风格因人而异。
...
def train_model(model, epochs, dl_train, dl_valid, log_step_freq):
    ...
    for epoch in range(1, epochs+1):
        ...
        info = (epoch, loss_sum/step, metric_sum/step,
                val_loss_sum/step, val_metric_sum/step)
